...
const Item = ({ title, thumbnail, price, stock }) => {
  return (
    <div className="bg-[#465775] hover:shadow-lg hover:shadow-black ease-in-out duration-300 w-[350px] my-4 p-3 flex-1 rounded-xl text-white shadow-md shadow-black">
